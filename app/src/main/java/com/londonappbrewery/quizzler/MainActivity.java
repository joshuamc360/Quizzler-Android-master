...
//  The 'AlertDialog Builder' will display a text box on top of the content of the app screen
        if (mIndex == 0){
    ...
    private void checkAnswer (boolean userSelction){

        boolean correctAnswer = mQuestionBank[mIndex].isAnswer();

        if (userSelction == correctAnswer) {
